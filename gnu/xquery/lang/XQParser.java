...
public class XQParser extends Lexer {
    ...
    public Expression parseDataType() throws IOException, SyntaxException {
        ...
        if (this.parseContext == NCNAME_COLON_TOKEN && max != 1) {
    ...
    public Expression parseMaybeKindTest() throws IOException, SyntaxException {
        ...
        switch (this.curToken) {
            ...
            case OP_PI /*233*/:
                ...
                if (this.curToken == NCNAME_TOKEN || this.curToken == 34) {
    ...
    Expression parseNodeTest(int axis) throws IOException, SyntaxException {
        ...
        if (etype != null) {
            args[0] = etype;
        } else if (this.curToken == NCNAME_TOKEN || this.curToken == QNAME_TOKEN || this.curToken == NCNAME_COLON_TOKEN || this.curToken == 415) {
    ...
    Expression parseMaybePrimaryExpr() throws IOException, SyntaxException {
        ...
        switch (token) {
            ...
            case 256:
                ...
                if (this.curToken == 123) {
                    getRawToken();
                    if (token == 253 || token == 254 || token == PI_TOKEN) {
            ...
            case 404:
                ...
                String msg;
                getRawToken();
                if (this.curToken == NCNAME_TOKEN || this.curToken == QNAME_TOKEN || this.curToken == NCNAME_COLON_TOKEN) {
